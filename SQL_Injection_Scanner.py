...
def form_details(form):
    ...
    detailsOffForm['action'] = action
    detailsOffForm['method'] = method
    detailsOffForm['inputs'] = inputs
    return detailsOffForm
...
def sql_injection_scan(url):
    ...
    for form in forms:
        ...
        for i in "\"'":
            ...
            if vulnerable(res):
                print("SQL injection attack vulnerability in link: ",
                url)
                break
        else:
...
if __name__ == "__main__":
    urlToBeChecked = "http://zero.webappsecurity.com"
